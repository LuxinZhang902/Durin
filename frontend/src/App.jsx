...
import { Upload, AlertTriangle, Shield, Network, FileText, Loader2, Sparkles, TrendingUp, Lock, Filter, Users, Globe2, ArrowRightLeft, Scale, User as UserIcon, Download, CreditCard, X, CheckCircle } from 'lucide-react'
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
          <div className="bg-dark-surface/95 backdrop-blur-2xl rounded-3xl border border-dark-border/30 shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8 space-y-6">
              {/* Card Preview */}
              <div className="bg-gradient-to-br from-accent-purple via-accent-blue to-accent-cyan rounded-2xl p-8 text-white shadow-2xl">
                <div className="flex justify-between items-start mb-8">
                  <Logo size="sm" showText={true} />
                  <div className="text-right">
                    <p className="text-xs opacity-70">Virtual Card</p>
                    <p className="text-sm font-semibold">Durin Secure</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <p className="font-semibold">{userData?.fullName || 'Your Name'}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs opacity-70 mb-1">Expires</p>
                      <p className="font-semibold">12/{new Date().getFullYear() + 3}</p>
                    </div>
                  </div>
                </div>
              </div>
