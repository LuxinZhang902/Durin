            ...
            <div className="flex items-center space-x-4">
              ...
              {userData && (
                <div className="relative user-menu-container">
                  ...
                  {/* Dropdown Menu */}
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-56 bg-dark-surface border border-dark-border/50 rounded-2xl shadow-2xl overflow-hidden z-[100]">
                      <div className="p-2">
                        <button
                          onClick={() => {
                            setShowUserMenu(false)
                          ...
                          className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-glass transition-all group text-left"
                        >
                        ...
                        <button
                          ...
                          className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-risk-high/10 transition-all group text-left"
                        >
